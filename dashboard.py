...
def init_api():
    ...
    init_api = requests.get(URL + "init_model", retries=False).json()
...
def load_selectbox():
    # Requête permettant de récupérer la liste des ID clients
    data_json = requests.get(URL + "load_data", retries=False)
    data = data_json.json()
...
def load_infos_gen():
    ...
    infos_gen = requests.get(URL + "infos_gen",retries=False)
    ...
    # et la classe 1
    targets = requests.get(URL + "disparite_target",retries=False)
...
def identite_client():
    ...
    infos_client = requests.get(URL + "infos_client", params={"id_client":id_client}, retries=False)
...
def load_age_population():
    ...
    data_age_json = requests.get(URL + "load_age_population", retries=False)
...
def load_revenus_population():
    ...
    data_revenus_json = requests.get(URL + "load_revenus_population", retries=False)
...
def load_prediction():
    ...
    prediction = requests.get(URL + "predict", params={"id_client":id_client}, retries=False)
...
def load_neighbors():
    ...
    neighbors = requests.get(URL + "load_neighbors", params={"id_client":id_client}, retries=False)
